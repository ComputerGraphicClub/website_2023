class ImageLazyLoad {
     ...
     */ loadImage({ sizeOfImageToLoad  }) {
        /**@type {{loadListener: * | EventListener, isLoaded: boolean, url: string}}*/ const currentImageData = this.#listOfImageData[sizeOfImageToLoad];
...
//# sourceMappingURL=index.dfbbfd2f.js.map
