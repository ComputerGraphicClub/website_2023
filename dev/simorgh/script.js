...
const sectionBox = document.querySelectorAll('.content-container');
...
for (let i = 0; i < sectionBox.length; i++) {
  sectionBox[i].style.filter = "unset";
}

sectionBoxHome.style.filter = "unset";
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.body.addEventListener("scroll", function (event) {
    ...
    if (document.title !== 'Simorgh - About' || document.title !== 'Simorgh - FAQ' || document.title === 'Simorgh - Contact') {
...
menuIcon.addEventListener('click', function () {
  ...
  if (mobileDeviceWidth.matches) {
    for (let i = 0; i < sectionBox.length; i++) {
      sectionBox[i].style.filter = sectionBox[i].style.filter === 'unset' ? 'blur(10px)' : 'unset';
    }

    sectionBoxHome.style.filter = sectionBoxHome.style.filter === 'unset' ? 'blur(10px)' : 'unset';
  }
...
if (document.title !== 'Simorgh - About') {
...
///////////////////////////////////////////////
/// Menu bg style for about, FAQ & Contact  ///
///////////////////////////////////////////////
